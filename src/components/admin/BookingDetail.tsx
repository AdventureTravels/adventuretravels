import { type BookingWithRelations, type PriceLine, type BookingAddress } from "@/lib/content/bookings";
...
import { StaffStatusSelect } from "@/app/portal/staff/(dashboard)/[id]/StaffStatusSelect";
import {
  updateStatusAction,
  updateNotesAction,
  ...
  deleteInvoiceAction,
  type BookingBasePath,
} from "@/lib/actions/bookingAdmin";
import styles from "@/app/admin/admin.module.css";

/** Detailscherm van een boeking, gedeeld door /staff en /admin/bookings. */
export function BookingDetail({ booking, basePath, error }: { booking: BookingWithRelations; basePath: BookingBasePath; error?: string }) {
  ...
  return (
    <div>
      <div className={styles.pageHead}>
        ...
        <StaffStatusSelect action={updateStatusAction.bind(null, basePath, booking.id)} status={booking.status} />
      </div>
      ...
      <div className={styles.card}>
        ...
        <form action={updateNotesAction.bind(null, basePath, booking.id)} className={styles.form}>
      ...
      <div className={styles.card}>
        ...
        <form action={updateParticipantsAction.bind(null, basePath, booking.id)}>
      ...
      <div className={styles.card}>
            ...
            <tbody>
              {booking.invoices.map((invoice) => (
                <tr key={invoice.id}>
                  ...
                  <td>
                    <form action={updateInvoiceStatusAction.bind(null, basePath, invoice.id, booking.id)}>
                      <select
                  ...
                  <td>
                    <form action={deleteInvoiceAction.bind(null, basePath, invoice.id, booking.id)}>
        ...
        <form action={addInvoiceAction.bind(null, basePath, booking.id)} className={styles.fieldRow} style={{ alignItems: "flex-end" }}>
